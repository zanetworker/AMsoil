...
* add plugin tests for each plugin (unit tests)
  * add tests for the DHCP AM to show how it is done and to automate testing when changing anything in this code base
...
* add new wiki page for geni_trust (and !maybe! add the stuff below, sift though it before)
